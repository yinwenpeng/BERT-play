...
class RteProcessor(DataProcessor):
    ...
    def get_combined_train_examples_wenpeng(self, filename, name_strs):
...
def main():
    ...
    if args.do_train:
        ...
        #SciTail
        # train_examples = processor.get_examples_SciTail_wenpeng('/save/wenpeng/datasets/SciTailV1/tsv_format/scitail_1.0_train.tsv')
        # eval_examples = processor.get_examples_SciTail_wenpeng('/save/wenpeng/datasets/SciTailV1/tsv_format/scitail_1.0_dev.tsv')
        #SICK
        # train_examples = processor.get_examples_SICK_wenpeng('/save/wenpeng/datasets/Dataset/SICK/train.txt')
        # eval_examples = processor.get_examples_SICK_wenpeng('/save/wenpeng/datasets/Dataset/SICK/dev.txt')

        #FEVER
        # train_examples = processor.get_examples_FEVER_wenpeng('/home/wyin3/Datasets/FEVER_2_Entailment/train.txt')
        # eval_examples = processor.get_examples_FEVER_wenpeng('/home/wyin3/Datasets/FEVER_2_Entailment/dev.txt')

        #MNLI
        # train_examples = processor.get_examples_MNLI_wenpeng(['/home/wyin3/Datasets/glue_data/MNLI/train.tsv'])
        # eval_examples = processor.get_examples_MNLI_wenpeng(['/home/wyin3/Datasets/glue_data/MNLI/dev_matched.tsv', '/home/wyin3/Datasets/glue_data/MNLI/dev_mismatched.tsv'])

        #combined
        # inter_task_names = ['SICK','SciTail', 'FEVER','MNLI','SNLI','GLUE-RTE']
        inter_task_names = ['MNLI','SNLI','SciTail','SICK']
        train_examples = processor.get_combined_train_examples_wenpeng('/home/wyin3/Datasets/MNLI-SNLI-SciTail-RTE-SICK/all.6.train.txt', inter_task_names)
    ...
    if args.do_train:
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            logger.info("test acc= %f, max_test_acc= %f", test_acc, max_test_acc)

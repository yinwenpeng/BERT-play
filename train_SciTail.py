...
from load_data import load_SciTail_bert_version
from bert_common_functions import LogisticRegression
import numpy as np

features_dataset, labels_dataset = load_SciTail_bert_version()
...
test_feature_lists = np.asarray(features_dataset[2], dtype='float32')
test_label_list = np.asarray(labels_dataset[2], dtype='int32')

...
from preprocess_Yahoo import evaluate_Yahoo_zeroshot, evaluate_Yahoo_zeroshot_2phases
...
def main():
    ...
    if args.do_train:
        ...
        train_examples, _, _ = processor.get_examples_Yahoo_wenpeng('/home/wyin3/Datasets/YahooClassification/yahoo_answers_csv/zero-shot-split/train.two.phases.txt', True)
    ...
    if args.do_train:
        ...
        eval_examples, eval_label_list, eval_coord_list = processor.get_examples_Yahoo_wenpeng('/home/wyin3/Datasets/YahooClassification/yahoo_answers_csv/zero-shot-split/test.two.phases.txt', False)
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                if iter_co %200==0:
                    ...
                    mean_f1, weighted_f1 = evaluate_Yahoo_zeroshot_2phases(pred_probs, pred_labels, eval_label_list, eval_coord_list, set(seen_classes))

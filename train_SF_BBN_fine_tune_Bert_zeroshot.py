...
from preprocess_SF import evaluate_SF_zeroshot
...
def main():
    ...
    if args.do_train:
        ...
        train_examples, _, _ = processor.get_examples_SF_wenpeng('/home/wyin3/Datasets/MNLI-SNLI-SciTail-RTE-SICK/BBN.SF.train.zeroshot.v1.txt')
    ...
    if args.do_train:
        ...
        eval_examples, eval_label_list, eval_coord_list = processor.get_examples_SF_wenpeng('/home/wyin3/Datasets/MNLI-SNLI-SciTail-RTE-SICK/BBN.SF.test.zeroshot.v1.txt')
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                if iter_co %100==0:
                    ...
                    mean_f1, weighted_f1 = evaluate_SF_zeroshot(preds, eval_label_list, eval_coord_list, 5)
                    # result = compute_metrics('F1', preds, all_label_ids.numpy())
                    loss = tr_loss/nb_tr_steps if args.do_train else None
                    test_acc = mean_f1#result.get("f1")
                    if test_acc > max_test_acc:
                        max_test_acc = test_acc
                    print('\ntest F1_match & F1_mismatch:', test_acc,weighted_f1, ' max_test_f1:', max_test_acc, '\n')

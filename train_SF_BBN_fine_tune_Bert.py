...
def main():
    ...
    pretrain_model_dir = '/home/wyin3/Datasets/fine_tune_Bert_stored/FineTuneOnSciTail'#FineTuneOnMNLI'
    ...
    if args.do_train:
        ...
        eval_examples, eval_label_list, eval_coord_list = processor.get_examples_SF_wenpeng('/home/wyin3/Datasets/MNLI-SNLI-SciTail-RTE-SICK/BBN.SF.test.txt')

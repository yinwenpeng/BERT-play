...
def main():
    ...
    parser.add_argument("--load_own_model",
                        action='store_true',
                        help="load_own_model.")
    parser.add_argument("--own_model_dir",
                        default=None,
                        type=str,
                        help="The output directory where the model predictions and checkpoints will be written.")
    ...
    if args.do_train:
        ...
        # train_examples = processor.get_combined_train_examples_wenpeng('/home/wyin3/Datasets/MNLI-SNLI-SciTail-RTE-SICK/all.5.train.txt', 'SNLI')
        # eval_examples = processor.get_test_examples_wenpeng('/home/wyin3/Datasets/RTE/test_RTE_1235.txt')
    ...
    if args.load_own_model:
        model = BertForSequenceClassification.from_pretrained(args.own_model_dir, num_labels=num_labels)
        tokenizer = BertTokenizer.from_pretrained(args.own_model_dir, do_lower_case=args.do_lower_case)
        print('load_own_model succeed.')
    else:
...
# CUDA_VISIBLE_DEVICES=2 python -u train_entailment_Bert_endTask.py --task_name rte --do_train --do_lower_case --bert_model bert-base-uncased --max_seq_length 128 --train_batch_size 32 --eval_batch_size 32 --learning_rate 2e-5 --num_train_epochs 3 --data_dir '' --own_model_dir '/home/wyin3/Datasets/fine_tune_Bert_stored/FineTuneOnFEVER' --output_dir '/home/wyin3/Datasets/fine_tune_Bert_stored/FineTuneOnRTE' --load_own_model
